...
<div class="row body bg-light ">
    <h1 class="text-center my-3">ADD NEW FACILITY</h1>
    <p>
    ...
    <table id="tableCustomer" class="table  table-striped table-bordered" style="width: 100%">
        <tr>
            <th>Mã Dịch Vụ</th>
            <td><input type="number" name="ma_dich_vu" id="ma_dich_vu"></td>
        </tr>
        <tr>
            <th>Tên Dịch Vụ</th>
            <td><input type="text"name="ten_dich_vu"id="ten_dich_vu"></td>
        </tr>
        <tr>
            <th>Diện Tích</th>
            <td>
        ...
        <tr>
            <th>Chi Phí Thuê</th>
            <td>
                <input type="number" name="chi_phi_thue"id="chi_phi_thue">
            </td>
        </tr>
        <tr>
            <th>Số Người Tối Đa</th>
            <td>
                <input type="number"name="so_nguoi_toi_da"id="so_nguoi_toi_da">
            </td>
        </tr>
        <tr>
            <th>Mã Kiểu Thuê</th>
            <td>
                <input type="number"name="ma_kieu_thue"id="ma_kieu_thue">
            </td>
        </tr>
        <tr>
            <th>Mã Loại Dịch Vụ</th>
            <td>
                <input type="number"name="ma_loai_dich_vu"id="ma_loai_dich_vu">
            </td>
        </tr>
        <tr>
            <th>Tiêu Chuẩn Phòng</th>
            <td>
                <input type="text"name="tieu_chuan_phong"id="tieu_chuan_phong">
            </td>
        </tr>
        <tr>
            <th>MT Tiện Nghi Khác</th>
            <td>
                <input type="text"name="mo_ta_tien_nghi_khac"id="mo_ta_tien_nghi_khac">
            </td>
        </tr>
        <tr>
            <th>Diện Tích Hồ Bơi</th>
            <td>
                <input type="number"name="dien_tich_ho_boi"id="dien_tich_ho_boi">
            </td>
        </tr>
        <tr>
            <th>Số Tầng</th>
            <td>
                <input type="number"name="so_tang"id="so_tang">
            </td>
        </tr>
        <tr>
            <th>DV Miễn Phí Đi Kèm</th>
            <td>
                <input type="text"name="dich_vu_mien_phi_di_kem"id="dich_vu_mien_phi_di_kem">
            </td>
        </tr>
        <tr>
