...
<div class="row body ">
    ...
    <h1 class="text-center my-3"> Sửa Khách Hàng </h1>
    <p>
    ...
    <form method="post" action="customer?action=edit">
        <table class="table table-striped">
            ...
            <tr>
                <th>Mã Khách Hàng :</th>
                <td>
                    <input type="text" name="ma_khach_hang" value="${requestScope['customer'].ma_khach_hang}"
                           id="ma_khach_hang"/>
                </td>
            </tr>
            <tr>
                <th>Mã Loại Khách :</th>
                <td>
                    <select name="ma_loai_khach"id="ma_loai_khach">
                        <c:forEach items="${customerTypeList}" var="customerType">
                            <option value="${customerType.ma_loai_khach}">${customerType.ten_loai_khach_hang}</option>
                        </c:forEach>
                    </select>
                </td>
            </tr>
            <tr>
                <th>Họ Tên :</th>
                <td>
                    <input type="text" name="ho_ten" value="${requestScope['customer'].ho_ten}" id="ho_ten"/>
                </td>
            </tr>
            <tr>
                <th>Ngày Sinh :</th>
                <td>
                    <input type="date" name="ngay_sinh" value="${requestScope['customer'].ngay_sinh}" id="ngay_sinh" s>
                </td>
            </tr>
            <tr>
                <th>Giới Tính :</th>
                <td>
                    <input checked type="radio" name="gioi_tinh" value="${requestScope['customer'].gioi_tinh}" id="nam"/><label>Nam</label>
                    <input type="radio" name="gioi_tinh" value="${requestScope['customer'].gioi_tinh}" id="nu"/><label>Nữ</label>
                </td>
            </tr>
            </tr>
            <tr>
                <th>Số CMND :</th>
                <td>
                    <input type="text" name="so_cmnd" value="${requestScope['customer'].so_cmnd}" id="so_cmnd"/>
                </td>
            </tr>
            <tr>
                <th>Số Điện Thoại :</th>
                <td>
                    <input type="text" name="so_dien_thoai" value="${requestScope['customer'].so_dien_thoai}"
                           id="so_dien_thoai"/>
                </td>
            </tr>
            <tr>
                <th>Email :</th>
                <td>
                    <input type="text" name="email" value="${requestScope['customer'].email}" id="email"/>
                </td>
            </tr>
            <tr>
                <th>Địa Chỉ :</th>
                <td>
                    <input type="text" name="dia_chi" value="${requestScope['customer'].dia_chi}" id="dia_chi"/>
                </td>
            </tr>
            <tr>
