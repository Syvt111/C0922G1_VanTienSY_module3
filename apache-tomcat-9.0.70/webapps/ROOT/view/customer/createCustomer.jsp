    ...
    <form method="post" action="customer?action=create">
        <table class="table table-striped">
            ...
            <tr>
                <th>Mã Khách Hàng :</th>
                <td>
                    <input type="text" name="ma_khach_hang" id="ma_khach_hang"/>
                </td>
            </tr>  <tr>
                <th>Mã Loại Khách :</th>
                <td>
                    <select name="ma_loai_khach"id="ma_loai_khach">
                        <c:forEach items="${customerTypeList}" var="customerType">
                            <option>${customerType.ma_loai_khach}</option>
                        </c:forEach>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                <th>Ngày Sinh :</th>
                <td>
                    <input type="date" name="ngay_sinh" id="ngay_sinh" s>
                </td>
            </tr>
            <tr>
                <th>Giới Tính :</th>
                <td>
                    ...
                    <input type="radio" name="gioi_tinh" id="nam"value="1"/><label>Nam</label>
                    <input type="radio" name="gioi_tinh" id="nu"value="0"/><label>Nữ</label>
                </td>
            </tr>
            </tr>
            <tr>
